from open_quantum_dynamics.heom import *
#from open_quantum_dynamics.core import random_rho
...
def heom_dynamics(rho0, H, baths, dt, tmax, chimax, tol = 1e-6, plot_aaa = False, fname=None, output_stride =10,iprint=0):
    nhilb = rho0.shape[0]
    nliouv = nhilb*nhilb
...
def main(iprint=0):
    ...
    rhos = heom_dynamics(rho0, H, baths, dt, tmax, chimax, tol=tol, plot_aaa=True, fname=fname,iprint=iprint)
